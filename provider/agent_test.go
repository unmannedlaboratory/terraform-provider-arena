	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{{
			...
			Check: func(state *terraform.State) error {
				...
				resource := state.Modules[0].Resources["arena_agent.new"]
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{{
			Config: `
				...
				resource "arena_agent_instance" "new" {
			...
			Check: func(state *terraform.State) error {
				...
				resource := state.Modules[0].Resources["arena_agent_instance.new"]
				require.NotNil(t, resource)
				for _, key := range []string{
					"agent_id",
					"instance_id",
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{{
			...
			Check: func(state *terraform.State) error {
				...
				resource := state.Modules[0].Resources["arena_agent.dev"]
				require.NotNil(t, resource)
